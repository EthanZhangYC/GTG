...
def main(**deps):
    ...
    if deps['task'] == 'ant':
        ...
        from config.our_config import Config
    Config._update(deps)
    ...
    trainer = trainer_config(diffusion, proxy_model, dataset, proxy_dataset, renderer, horizon=Config.horizon)#, args=deps)
